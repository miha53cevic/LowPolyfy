class Delunay_Triangulation {
    constructor() {
        ...
        const offset = 50;  // Inace su stranice pravokutnog trokuta tocno na rubovima canvasa
        const p1 = new Point(0 - offset, HEIGHT + offset);
        const p2 = new Point(HEIGHT / Math.tan(toRadian(45)) + WIDTH + offset, HEIGHT + offset);
        const p3 = new Point(0 - offset, Math.tan(toRadian(45)) * WIDTH * -1  - offset);
